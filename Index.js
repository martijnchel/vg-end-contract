...
// OMGEVINGSVARIABELEN (Stel deze in bij de Railway Service settings)
...
// CONFIGURATIE
const MAX_PER_DAG = 30; // Maximaal 30 webhooks per run
const WINDOW_START = 65; // Kijk vanaf 65 dagen voor einde
const WINDOW_END = 50;   // Tot 50 dagen voor einde
            ...
            for (const member of members) {
                ...
                if (contract) {
                    ...
                    if (visits.length >= MIN_VISITS_RECENT) {
                        ...
                        sentCount++;
                        console.log(`[${sentCount}/30] Verzonden: ${member.firstname} (Einddatum: ${contract.contract_end_date})`);
                        await sleep(3000); 
                    }
                }
            }
